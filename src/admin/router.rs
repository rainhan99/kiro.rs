...
use super::{
    handlers::{
        ...
        complete_social_relogin, context_calibration, create_client_key, create_group,
        create_session, delete_client_key, delete_credential, delete_group, delete_proxy,
        delete_session, disable_quota_exceeded, enable_overage_all, export_credentials,
        force_refresh_token, get_account_rpm_limit_config, get_account_throttle_config,
        get_all_credentials, get_cache_metering_config, get_credential_balance,
        get_credential_metadata_schema, get_credential_models, get_current_models,
        get_custom_models, get_global_proxy, get_load_balancing_mode, get_log_governance_config,
        get_proxy_pool, get_request_pipeline, get_security_config, get_self_heal_config,
        get_session_affinity_config, get_setup_status, get_update_config, list_client_keys,
        list_groups, list_traces, perform_setup, poll_idc_login, poll_idc_relogin,
        ...
        rotate_client_key, set_account_rpm_limit_config, set_account_throttle_config,
        set_cache_metering_config, set_client_key_disabled, set_client_key_max_credits,
        ...
        set_log_governance_config, set_proxy_enabled, set_security_config, set_self_heal_config,
        set_session_affinity_config, set_update_config, start_idc_login, start_idc_relogin,
        start_social_login, start_social_relogin, stats_by_credential, stats_by_key,
        stats_by_model, stats_overview, stats_timeseries, test_model, trace_failure_stats,
        trace_pipeline_evidence, update_admin_key, update_client_key, update_credential,
...
pub fn create_admin_router(state: AdminState) -> Router {
    ...
    let authenticated = Router::new()
        ...
        .route(
            "/config/security",
            get(get_security_config).put(set_security_config),
        )
